...
TICK_HZ = float(os.getenv("TICK_HZ", "60"))  # Nhịp vòng lặp AI (tối ưu: 60Hz ≈ 16.7ms/tick, khớp với 56 cmd/s ≈ 17.9ms/cmd)
MAX_CMDS_PER_SEC = float(os.getenv("MAX_CMDS_PER_SEC", "56"))  # Giới hạn lệnh move/s
